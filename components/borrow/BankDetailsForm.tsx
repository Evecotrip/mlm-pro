    ...
    <div className="space-y-8">
      ...
      <div className="bg-blue-500/10 border border-blue-500/20 rounded-xl p-4">
        <p className="text-sm text-blue-400">
          <strong className="text-blue-300">Note:</strong> Provide your bank details to receive digital payment from the lender.
        </p>
      </div>
        ...
        <div className="md:col-span-2">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-11 pr-4 py-3 bg-slate-950 border border-slate-800 rounded-xl text-white focus:ring-2 focus:ring-purple-500 focus:border-transparent outline-none transition-all placeholder:text-slate-600"
              disabled={loading}
            />
          </div>
        </div>
        ...
        <div>
          ...
          <div className="flex gap-4 mt-3">
            <label className="flex items-center gap-2 cursor-pointer group">
              <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center transition-colors ${bankDetails.accountType === 'savings' ? 'border-purple-500' : 'border-slate-600 group-hover:border-purple-400'
                }`}>
              ...
              <input
                ...
                disabled={loading}
              />
              <span className={`text-sm ${bankDetails.accountType === 'savings' ? 'text-white' : 'text-slate-400'}`}>Savings</span>
            </label>
            <label className="flex items-center gap-2 cursor-pointer group">
              <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center transition-colors ${bankDetails.accountType === 'current' ? 'border-purple-500' : 'border-slate-600 group-hover:border-purple-400'
                }`}>
              ...
              <input
                ...
                disabled={loading}
              />
              <span className={`text-sm ${bankDetails.accountType === 'current' ? 'text-white' : 'text-slate-400'}`}>Current</span>
            </label>
          </div>
        </div>
