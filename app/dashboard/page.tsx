          ...
          <div className="flex items-center gap-4">
            ...
            {pendingReferrals.length > 0 && (
              <button
                ...
                className="relative flex items-center gap-2 px-4 py-2 bg-orange-50 text-orange-600 hover:bg-orange-100 rounded-lg transition-colors font-semibold border-2 border-orange-200"
              >
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="grid md:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            <p className="text-2xl font-bold text-gray-900">{directReferrals.length}</p>
          </div>

          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <div className="flex items-center justify-between mb-2">
              <span className="text-gray-600 text-sm">Total Network</span>
              <Network className="w-5 h-5 text-orange-600" />
            </div>
            <p className="text-2xl font-bold text-gray-900">{allDownline.length}</p>
          </div>
        </div>

        {/* Referral Code Section */}
        <div className="bg-linear-to-r from-blue-500 to-purple-600 rounded-xl shadow-lg p-6 mb-8 text-white">
          <h3 className="text-lg font-semibold mb-3">Your Referral Code</h3>
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          {/* Network Hierarchy */}
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <h2 className="text-xl font-bold text-gray-900 mb-6">My Network Hierarchy</h2>
