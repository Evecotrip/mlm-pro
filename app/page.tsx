    ...
    <div className="min-h-screen bg-slate-950 text-slate-50 overflow-x-hidden selection:bg-blue-500/30">
      ...
      <nav className="relative z-50 container mx-auto px-6 py-6 flex justify-between items-center">
        <div className="flex items-center">
          <span className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-white to-slate-400">AuramX</span>
        ...
        <div className="flex items-center gap-4">
          <button onClick={() => router.push('/login')} className="text-sm font-medium text-slate-300 hover:text-white transition-colors">
            Login
          </button>
          <button
            onClick={() => router.push('/signup')}
            className="bg-white text-slate-950 px-5 py-2 rounded-full text-sm font-bold hover:bg-blue-50 transition-all hover:scale-105"
          >
            Get Started
          </button>
        </div>
      ...
      <section className="relative z-10 container mx-auto px-6 pt-20 pb-32 text-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-slate-900/50 border border-slate-800 backdrop-blur-md mb-8 animate-fadeIn">
          <span className="flex h-2 w-2 rounded-full bg-emerald-500 animate-pulse"></span>
          <span className="text-xs font-medium text-emerald-400 tracking-wide uppercase">Next Gen Investment Platform</span>
        </div>

        <h1 className="text-5xl md:text-7xl font-bold tracking-tight mb-8 bg-gradient-to-b from-white via-slate-200 to-slate-500 bg-clip-text text-transparent max-w-4xl mx-auto leading-[1.1]">
          The Future of <br />
          <span className="bg-gradient-to-r from-blue-400 via-purple-400 to-emerald-400 bg-clip-text text-transparent animate-shine">Decentralized Wealth</span>
        </h1>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <button className="group px-8 py-4 bg-slate-900/50 hover:bg-slate-800 border border-slate-800 text-white rounded-2xl font-bold text-lg transition-all backdrop-blur-md">
            <span className="flex items-center gap-2">
          ...
          <div className="relative bg-slate-900 border border-slate-800 rounded-3xl overflow-hidden shadow-2xl">
            ...
            <div className="p-4 md:p-8 grid grid-cols-3 gap-4 md:gap-8 opacity-90">
              <div className="col-span-2 space-y-4">
                ...
                <div className="h-48 bg-slate-800/50 rounded-2xl animate-pulse"></div>
              </div>
            ...
            <div className="absolute bottom-0 left-0 right-0 p-8 text-center">
              <p className="text-sm font-medium text-slate-400 uppercase tracking-widest">Trusted by 10,000+ Investors</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="relative z-10 container mx-auto px-6 py-24">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Why Choose AuramX?</h2>
          <p className="text-slate-400 max-w-2xl mx-auto">Built on advanced technology to ensure your assets are safe, growing, and always accessible.</p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            ...
            <div key={i} className="group p-8 rounded-3xl bg-slate-900/50 border border-slate-800 hover:border-slate-700 transition-all hover:bg-slate-900 hover:-translate-y-1">
      ...
      {/* CTA Section */}
      <section className="relative z-10 container mx-auto px-6 py-24">
        <div className="relative rounded-[3rem] overflow-hidden bg-gradient-to-br from-blue-900 to-slate-900 border border-slate-800 text-center px-6 py-20">
          <div className="absolute inset-0 bg-[url('https://grainy-gradients.vercel.app/noise.svg')] opacity-20"></div>
          <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-b from-transparent to-slate-950/80"></div>

          <div className="relative z-10 max-w-3xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">Ready to start your journey?</h2>
            <p className="text-xl text-slate-300 mb-10">Join thousands of investors who are already building their future with AuramX.</p>
            <button
              onClick={handleGetStarted}
              className="px-10 py-5 bg-white text-blue-900 rounded-2xl font-bold text-lg hover:bg-blue-50 transition-all hover:scale-105 shadow-xl"
            >
              Create Free Account
            </button>
          </div>
      ...
      <footer className="relative z-10 border-t border-slate-900 bg-slate-950 py-12">
        <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-slate-300">AuramX</span>
          </div>
          ...
          <p className="text-sm text-slate-600">© 2024 AuramX. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
