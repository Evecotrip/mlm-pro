...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
        ...
        <div className="container mx-auto px-3 sm:px-4 py-3 sm:py-4 flex justify-between items-center">
          ...
          <div className="flex gap-2 sm:gap-3">
            <button
              ...
              className="px-3 sm:px-6 py-2 text-blue-600 hover:text-blue-700 font-medium transition-colors text-sm sm:text-base"
            >
              Login
            </button>
            <button
              onClick={() => router.push('/signup')}
              className="px-3 sm:px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors font-medium text-sm sm:text-base"
            >
              Sign Up
            </button>
          </div>
      ...
      {/* Hero Section */}
      <main className="container mx-auto px-3 sm:px-4 py-10 sm:py-20">
        <div className="max-w-4xl mx-auto text-center mb-10 sm:mb-16">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
            <button
              onClick={() => router.push('/signup')}
              className="px-6 sm:px-8 py-3 sm:py-4 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors font-semibold text-base sm:text-lg flex items-center justify-center gap-2"
            >
              Get Started
            ...
            <button
              onClick={() => router.push('/login')}
              className="px-6 sm:px-8 py-3 sm:py-4 border-2 border-blue-600 text-blue-600 rounded-lg hover:bg-blue-50 transition-colors font-semibold text-base sm:text-lg"
            >
              Login to Dashboard
            </button>
          </div>
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-8 max-w-5xl mx-auto">
          <div className="bg-white p-5 sm:p-8 rounded-xl shadow-lg border border-gray-100">
            ...
            <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-2">Multiple Risk Profiles</h3>
          ...
          <div className="bg-white p-5 sm:p-8 rounded-xl shadow-lg border border-gray-100">
            ...
            <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-2">Flexible Lock-in Periods</h3>
            <p className="text-sm sm:text-base text-gray-600">
          ...
          <div className="bg-white p-5 sm:p-8 rounded-xl shadow-lg border border-gray-100">
            ...
            <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-2">Referral Network</h3>
            <p className="text-sm sm:text-base text-gray-600">
        ...
        <div className="mt-12 sm:mt-20 max-w-5xl mx-auto">
          <h2 className="text-2xl sm:text-3xl font-bold text-center text-gray-900 mb-8 sm:mb-12">Investment Tiers</h2>
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
            <div className="bg-gradient-to-br from-green-50 to-green-100 p-4 sm:p-6 rounded-xl border-2 border-green-200">
              <h3 className="text-xl sm:text-2xl font-bold text-green-900 mb-2">Low Risk</h3>
              <p className="text-3xl sm:text-4xl font-bold text-green-600 mb-3 sm:mb-4">5%</p>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-4 sm:p-6 rounded-xl border-2 border-blue-200">
              <h3 className="text-xl sm:text-2xl font-bold text-blue-900 mb-2">Moderate Risk</h3>
              <p className="text-3xl sm:text-4xl font-bold text-blue-600 mb-3 sm:mb-4">20%</p>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 p-4 sm:p-6 rounded-xl border-2 border-purple-200">
              <h3 className="text-xl sm:text-2xl font-bold text-purple-900 mb-2">High Risk</h3>
              <p className="text-3xl sm:text-4xl font-bold text-purple-600 mb-3 sm:mb-4">100%</p>
