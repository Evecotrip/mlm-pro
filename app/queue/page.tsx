    ...
    return (
      <div className="min-h-screen bg-slate-950 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-slate-400 font-medium tracking-wide">Checking status...</p>
        </div>
      </div>
    );
  }
        ...
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="text-sm text-slate-400 hover:text-red-400 flex items-center gap-2 transition-colors"
            >
        ...
        <div className="max-w-4xl w-full grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="bg-slate-900/50 backdrop-blur-xl border border-slate-800 rounded-3xl p-8 shadow-2xl relative overflow-hidden group">
            ...
            <div className="relative z-10 text-center">
              ...
              <div className="bg-slate-950 border border-slate-800 rounded-2xl p-6 text-left mb-6">
                <h2 className="text-sm font-semibold text-slate-300 mb-4 uppercase tracking-wider">Account Details</h2>
                <div className="space-y-4 text-sm">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <code className="font-mono font-bold text-blue-400 bg-blue-500/10 px-2 py-1 rounded">{userProfile.referralCode}</code>
                  </div>
                </div>
              </div>
          ...
          <div className="space-y-8">
            <div>
              ...
              <div className="space-y-0 relative">
                {/* Vertical Line */}
                <div className="absolute left-[19px] top-8 bottom-8 w-0.5 bg-slate-800"></div>

                {/* Step 1 */}
                <div className="relative flex gap-4 pb-8">
                  <div className="w-10 h-10 bg-emerald-500 rounded-full flex items-center justify-center flex-shrink-0 ring-4 ring-slate-950 z-10">
                    <CheckCircle2 className="w-6 h-6 text-slate-950" />
                  </div>
                  <div className="pt-2">
                    <h4 className="font-bold text-white">Registration Complete</h4>
                    <p className="text-sm text-slate-400 mt-1">Your account has been successfully created.</p>
                  </div>
                </div>

                {/* Step 2 */}
                <div className="relative flex gap-4 pb-8">
                  <div className="w-10 h-10 bg-yellow-500 rounded-full flex items-center justify-center flex-shrink-0 ring-4 ring-slate-950 z-10 animate-pulse">
                    <Clock className="w-6 h-6 text-slate-950" />
                  </div>
                  <div className="pt-2">
                    <h4 className="font-bold text-yellow-500">Awaiting Approval</h4>
                    <p className="text-sm text-slate-400 mt-1">Your referrer needs to verify and approve your account.</p>
                  </div>
                </div>

                {/* Step 3 */}
                <div className="relative flex gap-4">
                  <div className="w-10 h-10 bg-slate-800 rounded-full flex items-center justify-center flex-shrink-0 ring-4 ring-slate-950 z-10">
                    <span className="font-bold text-slate-500">3</span>
                  </div>
                  <div className="pt-2">
                    <h4 className="font-bold text-slate-600">Dashboard Access</h4>
                    <p className="text-sm text-slate-600 mt-1">Unlock full access to investments and features.</p>
                  </div>
                </div>
              </div>
            </div>
