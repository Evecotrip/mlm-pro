          ...
          <div className="grid gap-6">
            {pendingApprovals.map((approval) => {
              ...
              return (
                <div
                  key={approval.id}
                  className="group bg-slate-900/50 backdrop-blur-xl rounded-3xl border border-slate-800 p-6 hover:border-blue-500/50 transition-all duration-300"
                >
                    ...
                    <div className="flex items-start gap-4 flex-1 w-full">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center justify-between mb-1">
                          ...
                          <span className="px-3 py-1 bg-yellow-500/10 text-yellow-500 border border-yellow-500/20 rounded-full text-xs font-bold flex items-center gap-1.5">
                            <Clock className="w-3.5 h-3.5" />
                            Pending
                          </span>
                        </div>

                        <div className="grid sm:grid-cols-2 gap-y-2 gap-x-8 text-sm text-slate-400 mt-2">
                    ...
                    <div className="w-full lg:w-auto flex flex-col gap-4 min-w-[300px]">
                      <div className="bg-slate-950/50 rounded-xl p-4 border border-slate-800">
                        <div className="flex items-center justify-between text-sm">
                          ...
                          <span className="font-mono font-bold text-white">{requestData.referralCode || 'N/A'}</span>
                        </div>
                      </div>
                      ...
                      <div className="flex gap-3">
                        ...
                        <button
                          ...
                          disabled={approving === approval.id}
                          className="flex-1 flex items-center justify-center gap-2 px-4 py-3 bg-slate-800 hover:bg-red-500/20 text-slate-300 hover:text-red-500 border border-slate-700 hover:border-red-500/50 rounded-xl transition-all font-bold disabled:opacity-50 disabled:cursor-not-allowed"
                        >
